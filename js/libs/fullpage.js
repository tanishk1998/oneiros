    ...
    function (P, F) {
      ...
      if (!Q(K("html"), a)) {
        ...
        jn(), e.fp_easings = q(e.fp_easings, {
          ...
          for (var e = K(h), i = 0; i < e.length; i++) {
            ...
            }), void 0 !== F.anchors[S] && m.setAttribute("data-anchor", F.anchors[S]), d = s, v = r, void 0 !== F.anchors[v] && Q(d, c) && bn(F.anchors[v], v), F.menu && F.css3 && null != he(K(F.menu)[0], o) && se.appendChild(K(F.menu)[0]), f > 0 ? Mt(s, u, f) : F.verticalCentered && wn(s)
          }
          var d, v, m, S;
      ...
      function gt(e, t) {
        void 0 !== t ? (t = t.replace(/ /g, "").split(",")).forEach(function (t) {
          zn(e, t, "m")
        }) : (zn(e, "all", "m"), e ? (ht(!0), (Be || ze) && (F.autoScrolling && (se.removeEventListener(Je.touchmove, Rt, {
          passive: !1
        }), se.addEventListener(Je.touchmove, Rt, {
          passive: !1
        })), K(o)[0].removeEventListener(Je.touchstart, Nt), K(o)[0].removeEventListener(Je.touchmove, Bt, {
          passive: !1
        }), K(o)[0].addEventListener(Je.touchstart, Nt), K(o)[0].addEventListener(Je.touchmove, Bt, {
          passive: !1
        }))) : (ht(!1), (Be || ze) && (F.autoScrolling && (se.removeEventListener(Je.touchmove, Bt, {
          passive: !1
        }), se.removeEventListener(Je.touchmove, Rt, {
          passive: !1
        })), K(o)[0].removeEventListener(Je.touchstart, Nt), K(o)[0].removeEventListener(Je.touchmove, Bt, {
          passive: !1
        }))))
      ...
      function Ut(e, t) {
        var n, o, i, r, l = (o = e, i = t, (r = F.v2compatible ? {
          ...
          afterRender: function () {
            return {
              section: Ft(K(g)[0]),
              slide: Wt(K(O, K(g)[0])[0])
            }
          },
          onLeave: function () {
            return {
              origin: Ft(i.activeSection),
              destination: Ft(i.element),
