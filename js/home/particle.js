...
(psParticle.prototype.move = function() {
    ...
    (Particle.prototype.Particle = psParticle),
    (Particle.prototype.swapList = function(a, b, c) {
        var d = this
        a == null ?
            (a = new d.Particle(d)) :
            b.first == a ?
    ...
    (Particle.prototype.parseColor = function(a) {
        var b,
            a = a.replace(' ', '')
    ...
    (Particle.prototype.loadingStep = function() {
        var a = this
        a.imagesLoaded++
    ...
    (Particle.prototype.$ = function(a, b, c) {
        var d = this
        if (a[0] == '.') {
            var e = a.substr(1)
            b || (b = d.$$children)
    ...
    (Particle.prototype.nextSlide = function(a) {
        var b = this
    ...
    (Particle.prototype.getPixelFromImageData = function(a, b, c) {
        var d = this,
            e = []
    ...
    (Particle.prototype.init = function(a) {
        var b = this
        if (b.imgs.length > 0) {
            ;
    ...
    (Particle.prototype.getCw = function() {
        var a = this
        return Math.min(
    ...
    (Particle.prototype.getCh = function() {
        var a = this
        return Math.min(
    ...
    (Particle.prototype.setColor = function(a) {
        var b = this
        b.colorArr = b.parseColor(a)
    }),
    (Particle.prototype.setHoverColor = function(a) {
        var b = this
        b.hoverColorArr = b.parseColor(a)
    }),
    (Particle.prototype.requestAnimationFrame = function(a) {
        var b = this,
            c =
...
const mobile = `
  <div id="particles">
    <div class="logo">
      <div class="oneiros" data-src="/img/logos/logosmall.png"></div>
    </div>
    <canvas class="draw"></canvas>
  </div>
`
...
$(document).ready(() => {
    if (window.innerWidth < 800) {
        $('.home-splash').prepend(mobile)
    } else {
        $('.home-splash').prepend(desktop)
    }
